          ...
          <div class="body-wrap__content events-content">
            <div class="events-content__box-title">
              ...
              <h5 class="events-content__title events-title events-title--bold">
                Запись на урок сформирована и будет добавлена в ваш
                <a href="#">«Календарь»</a> . Учителю будет отправлено
                уведомление в чат
              </h5>
            </div>
            <p class="events-content__text">
              Отменить запись можно в
              <a href="#" class="events-content__text-link">«Календаре»</a> или
              через расписание учителя
            </p>
          </div>

<template>
  <main class="content cabinet-subject content_cabinet">
    ...
    >
      <h2 class="section-title">Программы из федерального реестра (12)</h2>
      <ul class="program-list programs-section__pragram-list">
        <li class="program-list__item">
          <a href="#" class="program-list__link"
            >Институт развития образования Сахалинской области</a
          >
        </li>
        <li class="program-list__item">
          <a href="#" class="program-list__link"
            >АНО ДПО "Сахалинский учебный центр "Сота"</a
          >
        </li>
        <li class="program-list__item">
          <a href="#" class="program-list__link">АНО ДПО «Учебный автоцентр»</a>
        </li>
        <li class="program-list__item">
          <a href="#" class="program-list__link"
            >АНО ДПО "Сахалинский учебный центр "Сота"</a
